...
var _fetchApiJs = require("./src/fetchApi.js");
var _mainUiJs = require("./src/mainUi.js");
var _storageJs = require("./src/storage.js");
...
function updateUI(response, main) {
    ...
    for(let i = 0; i < response.results.length; i++){
        ...
        if (poster_pat === null) filmImage.setAttribute("src", "https://picsum.photos/id/1/5000/3333");
        ...
        if (!isFavorite) {
            ...
            addToFavorites.addEventListener("click", ()=>{
                (0, _storageJs.addToFavoritesHandler)(i, allData);
...
},{"./storage.js":"bkDau","../journal.js":"4AICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bkDau":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addToFavoritesHandler", ()=>addToFavoritesHandler);
function addToFavoritesHandler(i, allData) {
    ...
    alert(`${nameOfFilm} wurde zu den Favoriten hinzugef\xfcgt!`);
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire8370")
