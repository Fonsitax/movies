...
})({"31uoF":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "72e2804497097fc5";
"use strict";
...
},{}],"4AICI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "favorites", ()=>favorites);
var _journalUiJs = require("./src/journalUi.js");
const favorites = JSON.parse(localStorage.getItem("favorites")) || [];
(0, _journalUiJs.updateUI)(favorites);

},{"./src/journalUi.js":"djgfv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"djgfv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateUI", ()=>updateUI);
var _deleteNoticeJs = require("./deleteNotice.js");
function updateUI(favorites) {
    ...
    for(let i = 0; i < favorites.length; i++){
        ...
        if (poster_path === "https://image.tmdb.org/t/p/w500null") filmbild = "https://picsum.photos/id/1/5000/3333";
        else filmbild = poster_path;
        ...
        removeBtn.textContent = "Von Favoriten l\xf6schen";
        removeBtn.classList.add("p-2", "bg-red-500", "rounded");
        removeBtn.addEventListener("click", ()=>{
            const deletedFilm = favorites.splice(i, 1);
            localStorage.setItem("favorites", JSON.stringify(favorites));
            alert(`Sie haben ${deletedFilm[0].Name} von Favoriten gel\xf6scht !!`);
            updateUI(favorites);
        });
        ...
        noteSave.addEventListener("click", ()=>{
            if (!note.value.trim()) alert("Sie m\xfcssen eine Notiz schreiben!");
            else {
                favorites[i].notice = note.value.trim();
                localStorage.setItem("favorites", JSON.stringify(favorites));
                alert("Sie haben eine Notiz hinzugef\xfcgt");
                updateUI(favorites);
            }
        });
...
},{"./deleteNotice.js":"fXIQG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fXIQG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteNotice", ()=>deleteNotice);
var _journalJs = require("../journal.js");
function deleteNotice(i) {
    delete (0, _journalJs.favorites)[i].notice;
    window.location.reload();
    localStorage.setItem("favorites", JSON.stringify((0, _journalJs.favorites)));
    alert("Sie haben die Notiz gel\xf6scht");
}

},{"../journal.js":"4AICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["31uoF","4AICI"], "4AICI", "parcelRequire8370")

//# sourceMappingURL=journal.97097fc5.js.map
